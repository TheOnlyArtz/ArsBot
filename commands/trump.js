...
exports.run = (client, message) => {
  ...
  if(!message.content.slice(7)) return message.reply("specify a thing that trump will make illegal");
  if(message.content.slice(7).length > 11) return message.reply("Max letters/numbers = 10 sorry..");
